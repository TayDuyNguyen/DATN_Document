...
Hệ thống được xây dựng theo kiến trúc máy khách - máy chủ, gồm các thành phần chính:
...
- API phía máy chủ sử dụng Laravel 12, PHP 8.2, JWT/Sanctum, mẫu Repository-Service, PostgreSQL/Supabase, bộ nhớ đệm Redis, tải ảnh Cloudinary, DomPDF và tích hợp thanh toán SePay.
...
Kết quả của đề tài là hệ thống DanangTrip gồm website người dùng, trang quản trị và API phía máy chủ, đáp ứng các nghiệp vụ chính như tra cứu địa điểm, quản lý tour, đặt tour, thanh toán, đánh giá, chatbot tư vấn và quản trị dữ liệu vận hành.
