...
| 20  | Điểm thành viên        | Người dùng đổi phần thưởng khi đủ điểm                                           | Điểm bị trừ một lần, giao dịch được lưu và phiếu giảm giá cá nhân được cấp                              | Điểm khả dụng được trừ chính xác, hệ thống ghi nhận lịch sử giao dịch điểm và cấp voucher    | Đạt           |
| 21  | Phiếu giảm giá cá nhân | Áp dụng phiếu còn hiệu lực của đúng người dùng                                   | Số tiền giảm được tính đúng và phiếu được đánh dấu đã sử dụng khi tạo đơn                               | Hóa đơn tự động trừ đi giá trị phiếu giảm giá, trạng thái phiếu đổi sang used khi đặt tour   | Đạt           |
| 22  | Đánh giá hữu ích       | Người dùng ghi nhận đánh giá công khai của người khác                            | Chỉ tạo một lượt ghi nhận; tăng số lượt hữu ích và xử lý điểm theo quy tắc                              | Số lượt hữu ích tăng 1, hệ thống cộng điểm thưởng cho tác giả và chặn bình chọn lặp lại     | Đạt           |
| 23  | Nhắc lịch khởi hành    | Chạy lệnh nhắc lịch với đơn đã xác nhận, đã thanh toán và khởi hành ngày kế tiếp | Tạo một thông báo cho mỗi đơn/ngày khởi hành và không gửi trùng                                         | Hệ thống tự động gửi thông báo in-app nhắc nhở lịch khởi hành trước 1 ngày cho khách hàng   | Đạt           |
