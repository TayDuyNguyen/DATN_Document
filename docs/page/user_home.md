...
|---------|--------|----------|--------|---------|
| Thời tiết | GET | `/weather` | ❌ 404 | Chưa implement |
...
| Cấu hình | GET | `/config` | ❌ 404 | Chưa implement |
| Gợi ý cá nhân (🔐) | GET | `/recommendations?limit=6` | ⚠️ 500 | Lỗi query tour_id trong views |
| Toggle yêu thích (🔐) | POST/DELETE | `/user/favorites` | ✅ 200 | Hoạt động |
...
### GET /weather ❌ 404 — Chưa implement

### GET /config ❌ 404 — Chưa implement
